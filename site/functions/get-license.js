// GET /api/get-license?session_id=cs_...
// Exchanges a paid Stripe Checkout Session for a signed GeoBrief license key.
// The unguessable session id (issued by Stripe) acts as proof of purchase.
// The key expires shortly after the current billing period, so a lapsed
// subscription stops unlocking the app; customers refresh the key from the
// same success page after each renewal.
//
