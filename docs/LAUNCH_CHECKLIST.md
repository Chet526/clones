...
- [x] [OPTIONAL] Representative supplemental CI sample for post-anchor docs-only commits is recorded for audit continuity (evidence: `docs/DEPLOYMENT_EVIDENCE.md` -> Supplemental CI Evidence section).
